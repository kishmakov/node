...
port.on('message', (message) => {
  try {
    ...
    console.log(`W: Error in ${message} handler: ${e}`); // TODO: remove once verified
  }
  ...
  if (message.type === LOAD_SCRIPT) {
    ...
    if (workerData.worker === true) {
      initWorker(publicPort);
      console.log(`W: Received ${LOAD_SCRIPT}: ${filename}`);
    }
