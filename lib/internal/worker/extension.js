...
const {createHandle} = require('internal/worker/serialization');
...
function createWorkerFunctionProxy(targetId, memberId, isAsync, funcStr) {
    ...
    return function (...args) {
        ...
        return createItemProxy(createHandle(resultId, null, EntityType.OBJECT, isAsync));
    };
}
...
function createHostFunctionProxy(targetId, memberId, _isAsync, funcStr) {
    ...
    function hostFuncProxy(...args) {
        ...
        let result = 'simpleValue' in callResult
            ...
            : createItemProxy(createHandle(resultId, null, callResult.type));
...
function initWorker(id, port) {
    ...
    setAPI('w:vscode', createItemProxy(createHandle(IDS.VSCODE + '#' + id)));
    setAPI('w:context', createItemProxy(createHandle(IDS.CONTEXT + '#' + id)));
