...
function saveObject(object, serialization) {
    runtime.cache.storeItem(serialization.NewItemID, object);
...
function createWorkerFunctionProxy(targetId, memberId, isAsync, funcStr) {
    ...
    return function (...args) {
        ...
        return createItemProxy({ NewItemID: resultId, NewType: EntityType.OBJECT, NewIsAsync: isAsync });
    };
}
...
function createHostFunctionProxy(targetId, memberId, _isAsync, funcStr) {
    ...
    function hostFuncProxy(...args) {
        ...
        let result = 'simpleValue' in callResult
            ...
            : createItemProxy({NewItemID: resultId, NewType: callResult.type});
...
function initWorker(id, port) {
    ...
    setAPI('w:vscode', createItemProxy({ NewItemID: IDS.VSCODE + '#' + id, NewType: EntityType.OBJECT }));
    setAPI('w:context', createItemProxy({ NewItemID: IDS.CONTEXT + '#' + id, NewType: EntityType.OBJECT }));
