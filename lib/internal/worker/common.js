...
// Code below goes to communication/common.js
...
const IDS = Object.freeze({
    ...
    TAGS: {
        NAME: 'name',
        PROXY_ITEM: 'ProxyItemID',
        ASYNC_FUNCTION: 'AsyncProxyFunction',
    },
    COMM: {
    ...
    REQ_TYPES: {
        ...
        W2H_CALL: 'w2h:call',
        W2H_UPDATE: 'w2h:update',
        // both directions
        ANY_TYPE: 'any:type',
        ANY_SET: 'any:set',
        ANY_PROMISE: 'any:promise',

    }
});

function isAsyncFunction(func) {
    if (func?.[IDS.TAGS.ASYNC_FUNCTION]) return true;
