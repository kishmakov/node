...
function syncType(port, callId, targetId, serialize) {
    const coord = `callId=${callId} targetId=${targetId} serialize=${serialize}`;
...
function asyncH2WCall(port, targetId, memberId, args, isAsync, resultId) {
    assert(typeof targetId === 'string', `failed: targetId != string @ asyncH2WCall`);
...
function syncH2WCall(targetId, memberId, args, isAsync, resultId) {
    assert(typeof targetId === 'string', `failed: targetId != string @ syncH2WCall`);
