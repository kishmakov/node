...
function v8H2WCall(targetId, memberId, args, isAsync) {
    ...
    logToFile(`RunOnPaused before targetId=${targetId} memberId=${memberId} args=${print(args)}`);
    const result = RunOnPaused(context.threadId, context.destId, H2W_CALL, targetId, memberId, args, isAsync);
